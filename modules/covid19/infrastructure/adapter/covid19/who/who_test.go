...
func newCovid19WHOAdapter(t *testing.T) (infC19Adp.ICovid19Adapter, *handler.Handler, error) {
...
func TestWHO_DisplayCurrentDataByCountry(t *testing.T) {
	adp, h, err := newCovid19WHOAdapter(t)
	if err != nil {
	...
	testData := viper.GetStringMapString("test-data.covid19.covid19.infra-layer.adapter.who")
